  ...
  const handleFileChange = (event) => {
    ...
    if (selectedFile) {
      ...
      if (validImageTypes.includes(fileType)) {
        ...
        alert(
          "Invalid file type. Please upload a JPEG, JPG, PDF, PNG or Word document."
        );
        setPreviewUrl("");
      }
  ...
  const handleSignatureChange = (event) => {
    ...
    if (selectedFile) {
      ...
      if (validImageTypes.includes(fileType)) {
        ...
        alert(
          "Invalid file type. Please upload a JPEG , JPG or PNG image for the signature."
        );
    ...
    <>
      ...
      <div className="container mt-5">
        <div className="d-flex flex-column align-items-center form-header">
          ...
          >
            Learn the art of dance Kathak 'Lucknow Gharana'
          </p>
          <p
            className="text-center"
            style={{
          ...
          >
            H.O.: 297, Shaniwar Peth, Behind Veer Maruti Mandir, Pune-30,
            Maharashtra - INDIA
          </p>
          <h2 className="text-center">REGISTRATION FORM & ADMISSION FORM</h2>
          <p className="text-center">
            Venue: ______________________________ Morning / Evening / Online
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group row">
            <label htmlFor="school" className="col-sm-2 col-form-label">
              School
            </label>
            <div className="col-sm-4">
              <input
          ...
          <div className="form-group row">
            ...
            <label htmlFor="maritalStatus" className="col-sm-2 col-form-label">
              Marital Status
            </label>
            <div className="col-sm-4">
              <select
          ...
          <div className="form-group row">
            <label htmlFor="aadhaarNo" className="col-sm-2 col-form-label">
              Aadhaar No.
            </label>
            <div className="col-sm-4">
              <input
            ...
            <label htmlFor="panNo" className="col-sm-2 col-form-label">
              PAN No.
            </label>
            <div className="col-sm-4">
              <input
          ...
          <div className="form-group row">
            <label htmlFor="religion" className="col-sm-2 col-form-label">
              Religion
            </label>
            <div className="col-sm-2">
              <input
            ...
            <label htmlFor="caste" className="col-sm-2 col-form-label">
              Caste
            </label>
            <div className="col-sm-2">
              <input
          ...
          <div className="form-group row">
            <label htmlFor="examsAppeared" className="col-sm-2 col-form-label">
              Exams appeared / Cleared
            </label>
            <div className="col-sm-10">
              <input
                type="text"
                ...
                className="form-control"
                id="examsAppeared"
                placeholder="Exams appeared / Cleared"
              />
            </div>
          </div>
          <div className="form-group row">
            <label htmlFor="gharana" className="col-sm-2 col-form-label">
              Gharana
            </label>
            <div className="col-sm-10">
              <input
          ...
          <div className="form-group row">
            ...
            <label for="fatherSign" className="col-sm-2 col-form-label">
              Father's Signature
            </label>
            <div className="col-sm-2">
              <input
          ...
          <div className="form-group row">
            ...
            <label for="MotherSign" className="col-sm-2 col-form-label">
              Mother's Signature
            </label>
            <div className="col-sm-2">
              <input
          ...
          <div className="form-group row">
            <label htmlFor="homeAddress" className="col-sm-2 col-form-label">
              Home-Address
            </label>
            <div className="col-sm-10">
              <textarea
          ...
          <div className="form-group row">
            ...
            <label htmlFor="alternatePhone" className="col-sm-2 col-form-label">
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10">
              <input
                ...
                id="formFileSm"
                type="file"
                onChange={combinedFileChangeHandler}
              />
            </div>
          </div>
                ...
                {signaturePreviewUrl && (
                  <div>
                    ...
                    <img
                      ...
                      alt="Father's Signature Preview"
                      className="img-thumbnail"
                      style={{ maxWidth: "200px" }}
                    />
                  </div>
